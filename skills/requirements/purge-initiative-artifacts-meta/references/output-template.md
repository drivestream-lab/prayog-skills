...
handoff:
  ...
  signals:
    ...
    refused_count: {n}
    pr_body: |
      Initiative closure — meta purge for {INIT}.
  ...
  forge:
    ...
    draft: true
    apply_labels: []
    title: "Initiative closure purge (meta): {INIT}"
    # body_path: ephemeral file outside reports_dir, materialized from
    # signals.pr_body by ForgeClient / human walker — never Purge-*.md
